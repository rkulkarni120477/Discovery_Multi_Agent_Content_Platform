"""End-to-end smoke test for the fully automated Scenario 3 graph using synthetic fixtures.
...
def test_full_run_reaches_final_package():
    ...
    assert not graph.get_state(config).next, "automated Scenario 3 must not pause for HITL review"
